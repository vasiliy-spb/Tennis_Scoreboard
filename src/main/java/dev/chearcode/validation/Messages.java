...
public enum Messages {
    ...
    TOO_SMALL_NAME_MESSAGE("name length must be grater then " + Limits.MIN_NAME_LENGTH.getValue()),
    TOO_LONG_NAME_PART_MESSAGE("name part length must be less then " + Limits.MAX_NAME_PART_LENGTH.getValue()),
    TOO_SMALL_NAME_PART_MESSAGE("name part length must be grater then " + Limits.MIN_NAME_PART_LENGTH.getValue()),
